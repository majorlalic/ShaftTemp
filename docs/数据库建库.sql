...
-- 4. ODS_DWEQ_DM_ALARM_RAW_D 原始告警存档表
-- 5. 主键、必要索引、唯一约束已内置

-- DM环境请在目标schema执行本脚本，以下MySQL建库语句已禁用
...
DROP TABLE IF EXISTS ODS_DWEQ_DM_DEVICE_ONLINE_LOG_D;
DROP TABLE IF EXISTS ODS_DWEQ_DM_RAW_DATA_D;
-- DROP TABLE IF EXISTS ODS_DWEQ_DM_DEVICE_RAW_DATA_D;
DROP TABLE IF EXISTS ODS_DWEQ_DM_ALARM_RAW_D;
DROP TABLE IF EXISTS ODS_DWEQ_DM_EVENT_D;
DROP TABLE IF EXISTS ODS_DWEQ_DM_ALARM_D;
DROP TABLE IF EXISTS ODS_DWEQ_DM_ALARM_RULE_D;
DROP TABLE IF EXISTS ODS_DWEQ_DM_MONITOR_PARTITION_BIND_D;
DROP TABLE IF EXISTS ODS_DWEQ_DM_MONITOR_DEVICE_BIND_D;
DROP TABLE IF EXISTS ODS_DWEQ_DM_SHAFT_FLOOR_D;
DROP TABLE IF EXISTS ODS_DWEQ_DM_MONITOR_D;
DROP TABLE IF EXISTS ODS_DWEQ_DM_DEVICE_D;
DROP TABLE IF EXISTS ODS_DWEQ_DM_ORG_D;
DROP TABLE IF EXISTS ODS_DWEQ_DM_AREA_D;

CREATE TABLE ODS_DWEQ_DM_AREA_D (
    ...
    updator bigint DEFAULT NULL COMMENT '更新人',
    deletor bigint DEFAULT NULL COMMENT '删除人',
...
CREATE TABLE ODS_DWEQ_DM_ORG_D (
    id bigint NOT NULL COMMENT '主键ID',
...
CREATE TABLE ODS_DWEQ_DM_DEVICE_D (
    id bigint NOT NULL COMMENT '主键ID',
...
CREATE TABLE ODS_DWEQ_DM_MONITOR_D (
    id bigint NOT NULL COMMENT '主键ID',
    ...
    device_id bigint DEFAULT NULL COMMENT '终端ID',
    remark varchar(500) DEFAULT NULL COMMENT '备注',
    deleted tinyint DEFAULT 0 COMMENT '是否删除',
    creator bigint DEFAULT NULL COMMENT '创建人',
    updator bigint DEFAULT NULL COMMENT '更新人',
...
CREATE TABLE ODS_DWEQ_DM_SHAFT_FLOOR_D (
    id bigint NOT NULL COMMENT '主键ID',
    monitor_id bigint DEFAULT NULL COMMENT '监测对象ID',
    area_id bigint DEFAULT NULL COMMENT '区域ID',
    name varchar(100) DEFAULT NULL COMMENT '楼层名称',
    device_id bigint DEFAULT NULL COMMENT '终端ID',
    start_point int DEFAULT NULL COMMENT '开始点位',
    end_point int DEFAULT NULL COMMENT '结束点位',
    sort int DEFAULT 0 COMMENT '排序号',
    deleted tinyint DEFAULT 0 COMMENT '是否删除',
    creator bigint DEFAULT NULL COMMENT '创建人',
    updator bigint DEFAULT NULL COMMENT '更新人',
    ...
    deleted_on datetime DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (id),
    KEY idx_ODS_DWEQ_DM_SHAFT_FLOOR_D_monitor_deleted (monitor_id, deleted),
    KEY idx_ODS_DWEQ_DM_SHAFT_FLOOR_D_device_deleted (device_id, deleted)
) COMMENT='ODS_DWEQ_DM_SHAFT_FLOOR_D表';

CREATE TABLE ODS_DWEQ_DM_MONITOR_DEVICE_BIND_D (
    id bigint NOT NULL COMMENT '主键ID',
    monitor_id bigint DEFAULT NULL COMMENT '监测对象ID',
    device_id bigint DEFAULT NULL COMMENT '终端ID',
    ...
    deleted_on datetime DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (id),
    KEY idx_ODS_DWEQ_DM_MONITOR_DEVICE_BIND_D_monitor_device_deleted (monitor_id, device_id, deleted)
) COMMENT='ODS_DWEQ_DM_MONITOR_DEVICE_BIND_D表';

CREATE TABLE ODS_DWEQ_DM_MONITOR_PARTITION_BIND_D (
    id bigint NOT NULL COMMENT '主键ID',
    monitor_id bigint DEFAULT NULL COMMENT '监测对象ID',
    device_id bigint DEFAULT NULL COMMENT '终端ID',
    shaft_floor_id bigint DEFAULT NULL COMMENT '楼层ID',
    ...
    deleted_on datetime DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (id),
    UNIQUE KEY uk_ODS_DWEQ_DM_MONITOR_PARTITION_BIND_D_device_partition_deleted (device_id, partition_id, deleted),
    KEY idx_ODS_DWEQ_DM_MONITOR_PARTITION_BIND_D_partition_deleted (partition_code, deleted),
    KEY idx_ODS_DWEQ_DM_MONITOR_PARTITION_BIND_D_reference_deleted (data_reference, deleted),
    KEY idx_ODS_DWEQ_DM_MONITOR_PARTITION_BIND_D_monitor_deleted (monitor_id, deleted)
) COMMENT='ODS_DWEQ_DM_MONITOR_PARTITION_BIND_D表';

CREATE TABLE ODS_DWEQ_DM_ALARM_D (
    id bigint NOT NULL COMMENT '主键ID',
    ...
    merge_count int DEFAULT 0 COMMENT '累计触发次数',
    event_count int DEFAULT 0 COMMENT '已记录事件次数',
    alarm_level tinyint DEFAULT NULL COMMENT '告警等级',
    title varchar(200) DEFAULT NULL COMMENT '告警标题',
    content varchar(1000) DEFAULT NULL COMMENT '告警内容',
    handler bigint DEFAULT NULL COMMENT '处理人ID',
...
CREATE TABLE ODS_DWEQ_DM_ALARM_RAW_D (
    id bigint NOT NULL COMMENT '主键ID',
    ...
    payload_json clob DEFAULT NULL COMMENT '原始消息项JSON',
    deleted tinyint DEFAULT 0 COMMENT '是否删除',
    created_on datetime DEFAULT NULL COMMENT '创建时间',
    PRIMARY KEY (id),
    KEY idx_ODS_DWEQ_DM_ALARM_RAW_D_iot_time (iot_code, collect_time),
    KEY idx_ODS_DWEQ_DM_ALARM_RAW_D_partition_time (partition_id, collect_time)
) COMMENT='上游告警原始数据表';

CREATE TABLE ODS_DWEQ_DM_ALARM_RULE_D (
    id bigint NOT NULL COMMENT '主键ID',
    ...
    scope_id bigint DEFAULT NULL COMMENT '作用对象ID，当前固定为NULL',
    level tinyint DEFAULT NULL COMMENT '告警等级',
    ...
    updated_on datetime DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (id),
    KEY idx_ODS_DWEQ_DM_ALARM_RULE_D_scope (biz_type, alarm_type, scope_type, scope_id, enabled, deleted)
) COMMENT='告警规则表';

CREATE TABLE ODS_DWEQ_DM_EVENT_D (
    id bigint NOT NULL COMMENT '主键ID',
    ...
    event_no int DEFAULT NULL COMMENT '事件序号',
    event_level tinyint DEFAULT NULL COMMENT '事件等级',
    point_list_json clob DEFAULT NULL COMMENT '触发点位列表',
    detail_json clob DEFAULT NULL COMMENT '事件详情',
...
CREATE TABLE ODS_DWEQ_DM_RAW_DATA_D (
    ...
    created_on datetime DEFAULT NULL COMMENT '创建时间',
    PRIMARY KEY (id),
    KEY idx_ODS_DWEQ_DM_RAW_DATA_D_iot_time (iot_code, collect_time),
    KEY idx_ODS_DWEQ_DM_RAW_DATA_D_device_partition_time (device_id, partition_id, collect_time),
    KEY idx_ODS_DWEQ_DM_RAW_DATA_D_monitor_time (monitor_id, collect_time),
    KEY idx_ODS_DWEQ_DM_RAW_DATA_D_partition_time (partition_id, collect_time)
) COMMENT='ODS_DWEQ_DM_RAW_DATA_D表';

CREATE TABLE ODS_DWEQ_DM_DEVICE_ONLINE_LOG_D (
    id bigint NOT NULL COMMENT '主键ID',
    device_id bigint DEFAULT NULL COMMENT '终端ID',
    ...
    created_on datetime DEFAULT NULL COMMENT '创建时间',
    PRIMARY KEY (id),
    KEY idx_ODS_DWEQ_DM_DEVICE_ONLINE_LOG_D_device_time (device_id, change_time)
) COMMENT='ODS_DWEQ_DM_DEVICE_ONLINE_LOG_D表';
