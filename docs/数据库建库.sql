...
CREATE TABLE monitor (
    ...
    community_area_id bigint unsigned DEFAULT NULL COMMENT '社区ID',
    estate_area_id bigint unsigned DEFAULT NULL COMMENT '小区ID',
    building_area_id bigint unsigned DEFAULT NULL COMMENT '楼栋ID',
    unit_area_id bigint unsigned DEFAULT NULL COMMENT '单元ID',
    service_range varchar(100) DEFAULT NULL COMMENT '服务范围',
