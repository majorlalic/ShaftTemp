...
### 1 告警表中确认人和确认时间改为处理人hanlder和处理时间handle_time, 更新数据库脚本和代码中的字段名

### 1. monitor不用社区，小区，楼栋，单元id，只需一个areaId就行吧，再冗余记录一个areaName，areaName是对应的全路径名称，用斜杠分开
