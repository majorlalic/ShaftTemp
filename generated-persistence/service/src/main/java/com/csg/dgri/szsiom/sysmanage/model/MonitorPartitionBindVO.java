...
/**
 * ODS_DWEQ_DM_MONITOR_PARTITION_BIND_D 对应 VO（自动生成）
 */
@Table(name = "ODS_DWEQ_DM_MONITOR_PARTITION_BIND_D")
public class MonitorPartitionBindVO extends CapBaseVO implements Serializable {

    private static final long serialVersionUID = 1L;

    public MonitorPartitionBindVO() {
    }
    @Id
    private Long id;
