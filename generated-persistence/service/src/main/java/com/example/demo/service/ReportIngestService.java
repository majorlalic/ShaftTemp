...
public class ReportIngestService {
    ...
    private final RawDataAppService<?> rawDataRepository;
    ...
    public ReportIngestService(
        ...
        RawDataAppService<?> rawDataRepository,
    ...
    private IngestResult ingestMeasureInternal(PartitionMeasureRequest request, boolean persistRawData) {
        ...
        Long rawDataId = null;
        if (persistRawData) {
            RawDataVO rawData = buildRawDataEntity(request, resolved, device, collectTime, metrics);
    ...
    private RawDataVO buildRawDataEntity(
        ...
        RawDataVO rawData = new RawDataVO();
    ...
    private void updateDeviceOnlineState(DeviceVO device, LocalDateTime collectTime) {
