...
import com.example.demo.entity.OrgEntity;
...
public interface OrgRepository {
    ...
    @Select("select * from ODS_DWEQ_DM_ORG_D where deleted is null or deleted = 0 order by sort asc, id asc")
    List<OrgEntity> findAllActive();

    @Update({
        "MERGE INTO ODS_DWEQ_DM_ORG_D t",
