...
import com.example.demo.dao.AlarmRuleRepository;
...
public class AlarmRuleResolverService {
    ...
    private final AtomicReference<List<AlarmRuleEntity>> cache = new AtomicReference<List<AlarmRuleEntity>>(new ArrayList<AlarmRuleEntity>());

    public AlarmRuleResolverService(AlarmRuleRepository alarmRuleRepository, AppProperties appProperties) {
    ...
    private RuleConfig toConfig(AlarmRuleEntity entity, BigDecimal fallbackThreshold) {
